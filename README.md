...
| **Medarbejder** (`#/medarbejder/<id>`) | Toggle strengths, log concrete highlights, note development areas, coffee preferences from the office machine and children's names/ages/interests, plan a MUS |
